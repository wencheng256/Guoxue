    ...
    <div class="mainer">
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li class="active"><a href="search.jsp" class="icon-cog"> 查询</a>
            		<ul><li><a href="person.jsp" target="right">个人查询</a></li><li><a href="classes.jsp" target="right">班级查询</a></li><li><a href="schools.jsp" target="right">学院查询</a></li></ul>
                </li>
                <li><a href="system.jsp" class="icon-file-text"> 设置</a>
